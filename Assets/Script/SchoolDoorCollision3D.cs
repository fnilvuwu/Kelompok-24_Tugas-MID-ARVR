...
public class SchoolDoorCollision3D : MonoBehaviour
{
    [SerializeField]
    private string nextSceneName = "MainScene"; // Name of the scene to load, you can set this in the Inspector too
